...
export default async function EmployeeCustomerDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div>
      <Header title={`Customer Profile: ${customer.user?.name || "Account"}`} subtitle="Staff CRM Profile View" />
